...
const WhatsAppCTA: React.FC = () => {
  ...
  // Enhanced WhatsApp business link with new messaging
  const whatsappLink = "https://wa.me/971509229009?text=I'm%20interested%20in%20learning%20how%20AI8TY%20can%20help%20build%20our%20intelligence-first%20business%20system";
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-depth-2 rounded-2xl p-8 md:p-12 border border-white/10 shadow-glow-md">
          <div className="text-center mb-8">
            <h2 className="heading text-3xl md:text-4xl mb-4">
              {isArabic 
                ? "النظام جاهز عندما تكون أنت كذلك"
                : "The system's ready when you are"}
            </h2>
            <p className="subheading max-w-2xl mx-auto">
              {isArabic 
                ? "تواصل معنا مباشرة عبر واتساب لبناء واجهة ذكية مع المستقبل"
                : "Connect with us directly through WhatsApp to build your intelligent interface with the future"}
            </p>
          </div>
          ...
          <div className="flex justify-center">
            <motion.a 
              ...
              className="inline-flex items-center gap-3 bg-[#25D366] hover:bg-[#22c55e] text-white px-8 py-4 rounded-xl font-bold text-lg shadow-lg transition-all duration-300"
            ...
            >
              ...
              {isArabic ? "ابدأ محادثة ذكية" : "Start an Intelligent Conversation"}
            </motion.a>
          </div>
          
          <div className="text-center mt-6">
            <p className="text-sm text-ai8ty-grey">
              {isArabic ? "سريع. ذكي. بدون ضغط." : "Fast. Smart. No pressure."}
            </p>
          </div>
        </div>
        ...
        <motion.div 
          className="absolute -bottom-16 -left-16 w-48 h-48 rounded-full border border-sand/5 opacity-20"
          animate={{ 
            rotate: 360,
            opacity: [0.1, 0.2, 0.1]
          }}
        ...
        <motion.div 
          className="absolute -top-20 -right-20 w-32 h-32 rounded-full border border-white/3 opacity-10"
          animate={{ 
            rotate: -360,
