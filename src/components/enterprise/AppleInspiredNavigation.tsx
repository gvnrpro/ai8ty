    ...
    >
      <div className="container-apple h-16 flex items-center justify-between">
        ...
        <motion.button
          ...
          className="flex items-center gap-3 hover-scale z-50 ml-3 md:ml-0 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-lg"
        ...
        <button
          ...
          className="md:hidden glass-apple p-2 rounded-lg z-50 hover-scale focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <motion.button
            ...
            className="btn-apple-secondary hover-lift text-caption focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="flex flex-col items-center justify-center h-full space-y-8 stagger-fade-in">
                <nav role="menu">
                  {navigationItems.map((item, index) => (
                    <div key={item.path} className="mb-6" role="none">
                      <NavButton
                        path={item.path}
                        label={item.label}
                        index={index}
