...
const ClientLogo: React.FC<ClientLogoProps> = ({
  ...
  return <div ref={ref} className={cn("flex items-center justify-center p-6 h-24 transition-all duration-700 filter grayscale hover:grayscale-0 hover:scale-110", inView ? "opacity-70 translate-y-0" : "opacity-0 translate-y-8")} style={{
